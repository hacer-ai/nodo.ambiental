...
st.set_page_config(
    page_title="Nodo + Educación Ambiental",
    page_icon="🧠",
...
st.sidebar.title("Nodo + Educación Ambiental ")
st.sidebar.divider()
st.sidebar.markdown("Mentor De Educación Ambiental ", unsafe_allow_html=True)
st.sidebar.markdown("hacer Agent Toolkit 1.0")
st.sidebar.divider()

st.write("""<img height="120" src="https://es.nodoeafit.com/wp-content/uploads/2024/11/EDUCACION-AMBIENTAL.png"/>""", unsafe_allow_html=True)
